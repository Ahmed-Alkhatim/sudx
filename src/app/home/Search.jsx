...
export default () => {
    ...
    return(
        <div className="relative">
            <input className="w-full h-[42px] border border-[#D9D9D9] rounded-full  px-[10px] py-[15px] " type="text" placeholder="Search" value={value} onChange={(e) => setValue(e.target.value)}/>
